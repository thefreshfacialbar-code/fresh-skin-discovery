...
type IconName = "droplet" | "shield" | "flower" | "sparkles" | "leaf" | "heart";
...
const answers: Answer[] = [
  {
    id: "feel-more-hydrated",
    icon: "droplet",
    title: "Feel more hydrated.",
    description: "I’d like my skin to feel comfortable, nourished and replenished.",
  },
  {
    id: "stay-clearer",
    icon: "shield",
    title: "Stay clearer between visits.",
    description: "I’d like fewer breakouts, clogged pores and periods of congestion.",
  },
  {
    id: "feel-calmer",
    icon: "flower",
    title: "Feel calmer and less reactive.",
    description: "I’d like my skin to feel more comfortable and less easily irritated.",
  },
  {
    id: "look-brighter",
    icon: "sparkles",
    title: "Look brighter and more radiant.",
    description: "I’d love a fresher, more luminous-looking complexion.",
  },
  {
    id: "feel-firmer-smoother",
    icon: "leaf",
    title: "Feel firmer and smoother.",
    description: "I’d like to support smoother texture, firmness and healthy aging.",
  },
  {
    id: "stay-healthy-balanced",
    icon: "heart",
    title: "Stay healthy and balanced.",
    description: "I’d like expert guidance to maintain skin that looks and feels healthy.",
  },
];
...
export default function DiscoveringQuestionPage() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-9 text-center">
          <h1 className="font-serif text-4xl leading-tight tracking-[-0.02em] sm:text-5xl">
            What would you love your skin to do more of?
          </h1>
        ...
        <div
          ...
          role="group"
          aria-label="What would you love your skin to do more of?"
        >
          {answers.map((answer) => {
